...
export default function RentPropertiesPage() {
  ...
  return (
    <Box bg={{ base: "gray.50", _dark: "gray.950" }} minH="100vh" py={{ base: 4, md: 8 }}>
      <Container maxW="1200px" px={{ base: "4", md: "6" }}>
        <Stack gap={6}>
          ...
          <Box mt={2}>
            <PropertyList
              keyword={keyword} location={location} type="Rent"
              propertyType={propertyType} maxPrice={maxPrice} minArea={minArea}
              hasSearched={true}
            />
          </Box>
        </Stack>
