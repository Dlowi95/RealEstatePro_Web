...
import { Box, Button, Container, Heading, Input, Text, SimpleGrid, Field, NativeSelect, Stack, Spinner, Center } from "@chakra-ui/react";
            ...
            <form onSubmit={handleSubmit}>
              <Stack gap={5}>
                <Field.Root required>
                  ...
                  <Input name="title" value={formData.title} onChange={handleChange} bg={{ base: "white", _dark: "gray.800" }} color={{ base: "gray.800", _dark: "whiteAlpha.900" }} borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} />
                </Field.Root>

                <SimpleGrid columns={{ base: 1, md: 3 }} gap={4}>
                  <Field.Root required>
                    <Field.Label fontWeight="600" color={{ base: "gray.900", _dark: "whiteAlpha.900" }}>Giá (VNĐ)</Field.Label>
                    <Input name="price" type="number" value={formData.price} onChange={handleChange} bg={{ base: "white", _dark: "gray.800" }} color={{ base: "gray.800", _dark: "whiteAlpha.900" }} borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} />
                  </Field.Root>

                  <Field.Root required>
                    <Field.Label fontWeight="600" color={{ base: "gray.900", _dark: "whiteAlpha.900" }}>Diện tích (m2)</Field.Label>
                    <Input name="area" type="number" value={formData.area} onChange={handleChange} bg={{ base: "white", _dark: "gray.800" }} color={{ base: "gray.800", _dark: "whiteAlpha.900" }} borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} />
                  </Field.Root>

                  <Field.Root required>
                    <Field.Label fontWeight="600" color={{ base: "gray.900", _dark: "whiteAlpha.900" }}>Số ĐT liên hệ</Field.Label>
                    <Input name="contactPhone" type="tel" value={formData.contactPhone} onChange={handleChange} bg={{ base: "white", _dark: "gray.800" }} color={{ base: "gray.800", _dark: "whiteAlpha.900" }} borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} />
                  </Field.Root>
                </SimpleGrid>
                ...
                <Box border="1px solid" borderColor={{ base: "gray.100", _dark: "whiteAlpha.200" }} p={4} rounded="md" bg={{ base: "gray.50", _dark: "gray.950" }}>
                  ...
                  <Input name="address" value={formData.address} onChange={handleChange} bg={{ base: "white", _dark: "gray.800" }} color={{ base: "gray.800", _dark: "whiteAlpha.900" }} borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} />
                </Box>

                <Field.Root>
                  <Field.Label fontWeight="600" color={{ base: "gray.900", _dark: "whiteAlpha.900" }}>Hình ảnh ({images.length})</Field.Label>
                ...
                <Field.Root required>
                  <Field.Label fontWeight="600" color={{ base: "gray.900", _dark: "whiteAlpha.900" }}>Mô tả</Field.Label>
                  <Box bg={{ base: "white", _dark: "gray.800" }} border="1px solid" borderColor={{ base: "gray.200", _dark: "whiteAlpha.200" }} rounded="md" width="full">
